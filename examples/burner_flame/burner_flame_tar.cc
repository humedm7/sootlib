...
int main(int argc, char** argv) {
    ...
    // Uncomment yBio, bio_inputs, get_mtar_ytar, and getyBio if using AJ_RED tar model
    ...
    ofstream ofile("burner_tar.out");

    //---------- integrate: second order midpoint method

    cout << endl << "********* Writing output to burner_tar.out" << endl;
